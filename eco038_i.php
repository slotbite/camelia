<?php
// Sistema			: ECO
// Programa			: eco038_i.PHP
// Descripcion		: Imprime Exámen EcoDoppler Extremidades Inferiores.
...
<head><title>Imprime EcoDoppler Extremidades Inferiores</title>
...
{ 
	...
	$consulta="call ECO_PSEL_ECOARTERIALNORMAL('".$codigo_w."',null,null,null,null,null)";
    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; position: absolute; width: 756px;" >
      <tr> 
        <td style="height: 24px" valign="bottom" colspan="2" align="center" width="500"> <span id="Label1" class="texto18"> 
          ECO DOPPLER ARTERIAL EXTREMIDADES INFERIORES</span></td>
      </tr>
      <tr> 
		...
		<table width="600" height="448" border="0" align="left" cellpadding="0" cellspacing="0" class="texto13" id="Table2"
           ...
           <tr> 
            ...
            <tr> 
              <td  colspan="2" style="width: 500px; height: 2px;text-decoration: underline;" align="center" class="txtngr">CONCLUSION</td>
              
            </tr>
			 <tr> 
              
              <td style="width: 500px; height: 3px" colspan="2"> 
