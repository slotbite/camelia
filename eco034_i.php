  ...
  <tr>
    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; position: absolute; width: 756px;" >
      ...
      <tr> 
		...
		<table width="612" height="387" border="0" align="left" cellpadding="0" cellspacing="0" class="texto13" id="Table2"
            ...
            <tr> 
			 ...
			 <tr> 
              <td style="width: 500px; height: 2px;text-decoration: underline;" align="center" colspan="2" class="txtngr"> IMPRESION DIAGNOSTICA</td>
            </tr>
			<tr> 
              <td height="37" style="width: 105px; height: 2px">&nbsp;</td>
              <td style="width: 314px; height: 2px">&nbsp;</td>
