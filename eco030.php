...
// Sistema			: ECO
// Programa			: ECO030.PHP
// Descripcion		: Ingreso Exámen EcoDoppler Venoso Bilateral.
...
<head><title>EcoDoppler Venoso Bilateral</title>
...
//          window.open('eco_autoriza.php?PAGINA=' + 'eco002.php' ,'Paciente','width=650, height=550, status=yes, resizable=no , menubar=yes, scrollbars=yes, location=no, top=150, left=220').focus();
	...
	/*-----------------------------------*/
        ...
        window.open('eco_autoriza.php?PAGINA=' + 'eco030_i.php?CODIGO=' + cod,'eco030_i','width=650, height=550, status= no, resizable= yes, menubar=yes, scrollbars=yes, location=no, top=150, left=220').focus();
...
if (isset($_POST['txt_detalle'])){
	...
	$detalle_w  = "Se utiliza una sonda doppler color lineal de 7.5 Mhz. de alta capacidad de resolución.  Se examina en forma continua los troncos venosos de ambas extremidades inferiores, y se toma fotos B/N y color sólo en algunos sitios de interés.

Se encuentra las venas femoral común, superficial y profunda, la vena poplítea y las venas tibiales posteriores de calibre amplio, de paredes finas y compresibles, permeables  en forma espontánea en las curvas de Doppler venoso y en el Doppler color, sin imágenes ecogénicas intraluminales, con buena  capacidad de aumento de flujo venoso frente a la compresión distal y buena competencia valvular con maniobra de Valsalva y frente a la compresión proximal.

El cayado de la vena safena interna en los dos lados aparece  de calibre normal, compresible y está permeable en el Doppler y en el Doppler color, con buena continencia valvular  frente a la maniobra de Valsalva.  La vena safena externa en ambos lados está normal, permeable y competente.  Siguiendo con la sonda Doppler las venas tibiales posteriores en la cara interna de ambas piernas no observo venas perforantes insuficientes o dilatadas.
";
	}
if (isset($_POST['txt_conclusion'])){
	...
	$conclusion_w = "Sistema venoso profundo permeable en ambas extremidades inferiores.  Sin signos de trombosis venosa profunda o superficial actual";
...
if ($_GET["CODIGO"] > 0)
	...
	$consulta="call ECO_PSEL_ECODOPVENBILATERAL('".$_GET["CODIGO"]."',null,null,null,null,null)";
    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; left: 16px; position: absolute; top: 6px; height: 498px; width: 623px;" width="510">
      <tr>
        ...
        <td style="height: 24px" valign="bottom"> <span id="Label1" class="texto18"> 
          ECODOPPLER COLOR VENOSO DE LAS EXTREMIDADES INFERIORES</span></td>
            </tr>
            <tr>
                <td style="background-image: url(ivvpp0002.jpg); width: 34px; height: 24px">
                </td>
...
//		$sql1 = "call ECO_PUPD_PACIENTES('I','".$rut_w."','".$nombre_w."','".$apepat_w."','".$apemat_w."',null,null,null,null,null,null,null,null,null)";
		$sql1 = "call ECO_PUPD_ECODOPVENBILATERAL('".$modo_w."','".$codigo_w."','".$rutpac_w."',STR_TO_DATE('".$fecha_w."','%d/%m/%Y'),";
