<?php
// Sistema			: ECO
// Programa			: eco026_i.PHP
// Descripcion		: Imprime Exámen EcoDoppler Carotideo Bilateral.
...
<head><title>Imprime EcoDoppler Carotideo Bilateral</title>
...
{ 
	...
	$consulta="call ECO_PSEL_ECOCAROTIDEO('".$codigo_w."',null,null,null,null,null)";
...
?>
  ...
  <tr>
    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; position: absolute; height: 468px; width: 756px;">
      <tr> 
        <td  colspan="2" align="center" width="500" style="height: 24px" valign="bottom"> <span id="Label1" class="texto18"> 
          ECO-DOPPLER CAROTIDEO-BILATERAL</span></td>
      </tr>
      <tr> 
        <td  colspan="2" align="left" height="100" width="480"> 
		<table width="512" height="377" border="0" align="center" cellpadding="0" cellspacing="0" class="texto13" id="Table2"
            ...
            <tr style="color: #000000"> 
              <td background="ivvpp0003.jpg" colspan="2" height="3" style="width: 381px"> 
              </td>
            </tr>
           <tr> 
            ...
            <tr> 
              <td style="width: 125px; height: 2px"  class="txtngr">Detalle Exámen</td>
              <td style="width: 314px; height: 3px"></td>
            </tr>
			<tr> 
              <td style="width: 514px; height: 2px; text-align: justify;" colspan="2" >
                <?php echo nl2br($detalle_w); ?>
              </td>
             </tr>
			...
			<tr> 
              <td style="width: 314px; height: 2px"  colspan="2" class="txtngr">Arteria 
                Carótida Interna Derecha :</td>
            </tr>
			<tr> 
              <td style="width: 514px; height: 2px; text-align: justify;" colspan="2" >
                <?php echo nl2br($artcarintder_w); ?>
              </td>
             </tr>
			<tr> 
              <td height="37" style="width: 105px; height: 2px">&nbsp;</td>
			...
			<tr> 
              <td style="width: 314px; height: 2px"  colspan="2" class="txtngr">Arteria 
                Carótida Externa Derecha :</td>
            </tr>
			<tr> 
              <td style="width: 514px; height: 2px; text-align: justify;" colspan="2" >
                <?php echo nl2br($artcarextder_w ); ?>
              </td>
             </tr>
			<tr> 
              <td height="37" style="width: 105px; height: 2px">&nbsp;</td>
            ...
            <tr> 
              <td style="width: 105px; height: 2px;text-decoration: underline;" class="txtngr">CONCLUSION</td>
            </tr>
			 <tr> 
