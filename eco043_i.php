...
<!--
	...
	-->
    <table id="Table1" border="0" cellpadding="0" cellspacing="0"  align="left" >
	<!--
      <tr> 
      ...
      <tr> 
        <td  colspan="2" align="left" height="100" width="700">
		 <table height="359" border="0" align="left" cellpadding="0" cellspacing="0" class="texto1313" id="Table2"
            ...
            <tr> 
              <td colspan="6" style="width: 381px; height: 14px"> </td>
            </tr>
            <tr> </tr>
			<!--
            ...
            <tr style="color: #000000"  > 
              ...
              <td width="400"  colspan="2" style= "height: 2px"><?php //echo $nompac_w ?></td>
		      <td style="width: 100px; height: 2px">  Edad : </td>
              <td style="width: 95px; height: 2px" ><?php //if($edad_w<>0){echo $edad_w . "  años";} else{echo "";} ?></td>
		      <td style="width: 20px; height: 2px">&nbsp;</td>

            </tr>
            <tr> 
              <td height="22" style="width: 95px; height: 2px">Rut : </td>
              <td  colspan="2" style="width: 214px; height: 2px"><?php //echo getPuntosRut($rutpac_w); ?></td>
			  <td  width="200" style="height: 2px">  Fecha Exámen : </td>
              <td style="width: 55px; height: 2px"><?php //echo $fecha_w; ?></td>
  		      <td style="width: 20px; height: 2px">&nbsp;</td>
           ...
           <tr> 
			...
			<tr> 
              <td style="height: 2px;" width="600" colspan="6"  >
                <?php 
				echo $detalle_w; 
				?>
              </td>
            ...
            <tr> 
			  ...
			  <td style="width: 55px; height: 2px"></td>
               ...
               <td  colspan="3" style="height: 3px" align="center"> 
                <?php echo "Dr. " . $nommed_w; ?>
              </td>
            </tr>
            <tr> 
              <td style="width: 95px; height: 2px"></td>
			  <td style="width: 95px; height: 2px"></td>
  			  <td style="width: 95px; height: 2px"></td>
              <td  colspan="3" style="height: 3px" align="center"> 
                <?php echo "Rut : " . getPuntosRut($rutmed_w); ?>
              </td>
            </tr>
            <tr> 
              <td style="width: 95px; height: 2px"></td>
			  <td style="width: 95px; height: 2px"></td>
  			  <td style="width: 95px; height: 2px"></td>
              <td  colspan="3" style="width: 314px; height: 3px" align="center"> 
                <?php echo $especial_w; ?>
              </td>
            </tr>
          </table>
