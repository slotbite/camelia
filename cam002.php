...
if ($_POST) {
    $_SESSION['nomfa_s'] = $_POST['cmd_nomfa'];
    $_SESSION['rasoc_s'] = $_POST['cmd_rasoc'];
    $_SESSION['rutpro_s'] = $_POST['cmd_rutpro'];
			...
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="530" border="0">
				...
				<TR>
					<td align="left" width="500" height="6">
						<TABLE width="509" height="93" border="0" cellPadding="0" class="texto13" id="Table2">
        <TR> 
							<td width="100" style="WIDTH: 100px; HEIGHT: 2px">Nombre Fantasía</td>
							<td width="224" style="WIDTH: 224px; HEIGHT: 2px"><input name="cmd_nomfa" type="text" id="cmd_nomfa" class="input-normal" style="width:216px;" value="<?php if (isset($_SESSION['nomfa_s'])){ echo $_SESSION['nomfa_s']; } ?>"/></td>
							<td width="118" align="center" style="WIDTH: 70px; HEIGHT: 2px"></td>
							<td width="57" align="center" style="HEIGHT: 2px"></td>
						  </TR>
						  <TR> 
							<td style="WIDTH: 100px; HEIGHT: 2px">Razón Social</td>
							<td style="WIDTH: 224px; HEIGHT: 2px"><input name="cmd_rasoc" type="text" id="cmd_rasoc" class="input-normal" style="width:216px;" value="<?php if (isset($_SESSION['rasoc_s'])){ echo $_SESSION['rasoc_s']; } ?>"/></td>
							<td style="WIDTH: 70px; HEIGHT: 2px" align="center"></td>
							<td style="HEIGHT: 2px" align="center"></td>
						  </TR>
						  <TR> 
							<td style="WIDTH: 100px; HEIGHT: 2px">Rut.</td>
							<td style="WIDTH: 224px; HEIGHT: 2px"><input name="cmd_rutpro" type="text" id="cmd_rutpro" class="input-normal" style="width:216px;" value="<?php if (isset($_SESSION['rutpro_s'])){ echo $_SESSION['rutpro_s']; } ?>"/></td>
							<td style="WIDTH: 70px; HEIGHT: 2px" align="center"></td>
							<td style="HEIGHT: 2px" align="center"></td>
						  </TR>
						  <TR> 
							<td height="22" style="WIDTH: 90px; HEIGHT: 2px">Código</td>
							<td style="WIDTH: 224px; HEIGHT: 2px"><input name="cmd_codpro" type="text" id="cmd_codpro" class="input-normal" style="width:216px;" value="<?php if (isset($_SESSION['codpro_s'])){ echo $_SESSION['codpro_s']; } ?>"/></td>
...
if ($_POST) 
{
 if (isset($_POST["cmd_buscar"]) )
    ...
    $extra = 'cam002_muestra.php?OPC=$opc_w' ;
/*		echo "<script>parent.frames['mainFrame'].location.href= 'eco_autoriza.php?PAGINA="."'eco002_muestra.php?OPC=';</script>";
*/
	echo "<script>parent.frames['mainFrame'].location.href='cam002_muestra.php?OPC=$opc_w';</script>";
