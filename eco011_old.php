...
<link href="ecocss/vvppcss.css" type="text/css" rel="stylesheet" />
	...
	/*---------------------------*/
        ...
        /*-----------------------------------*/
//          pant_pac = window.open("","Paciente","top=150,left=200,width=530,height=450,status=yes,scrollbars=yes,resizable=no");
//	      pant_pac.location = "eco002.php" ;
...
//	mysql_select_db(DB_NAME, $link); 
	...
	$consulta="call ECO_PSEL_SOLICITUDES('".$_GET["CODIGO"]."',null,null,null,null,null)";
      ...
      <tr>
          ...
          <tr>
            ...
            <tr> 
              ...
              <td style="width: 314px; height: 3px"> <input name="cmd_medico" type="text" maxlength="60" id="cmd_medico" class="input-normal" style="width:220px;" value="<?php echo $_SESSION['nommed_s']; ?>" /> 
<!--			  
                <input name="imgMedico" type="image" src="ieco/isase458.jpg" width="19" height="19" border="0" onclick="f_SelMedico(1)"/> 
                <input name="cmd_rutmed" type="text" id="cmd_rutmed" class="input-normal" style="border:1px solid #FFFFFF;" value="<?php echo $_SESSION['rutmed_s']; ?>" readOnly="readonly"/> 
				-->
            ...
            <tr> 
              ...
              <td style="width: 314px; height: 3px"> <input name="cmd_medico2" type="text" maxlength="60" id="cmd_medico22" class="input-normal" style="width:220px;" value="<?php echo $_SESSION['nommed2_s']; ?>" readonly="readonly"/> 
                <input name="imgMedico2" type="image" src="ieco/isase458.jpg" width="19" height="19" border="0" onclick="f_SelMedico(2)"/> 
                <input name="cmd_rutmed2" type="text" id="cmd_rutmed2" class="input-normal" style="border:1px solid #FFFFFF;" value="<?php echo $_SESSION['rutmed2_s']; ?>" readOnly="readonly"/> 
                &nbsp; <span id="MEfeMalo" style="color:Red;font-weight:bold;display:none;">Ingrese 
                Medico Efectúa </span></td>
            </tr>
            <tr style="color: #000000"> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 381px"> 
              </td>
            ...
            <tr> 
              ...
              <td style="width: 314px; height: 3px"> 
                <?php
			  echo $lst_prevision;
			  echo '&nbsp; <span id="PrevMalo" style="color:Red;font-weight:bold;display:none;">Seleccione Prevision 
                </span>'
  			  ?>
              </td>
            </tr>
...
*/
	...
	if (strlen($nommed2_w) == 0) { //que ingrese nombre
