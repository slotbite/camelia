...
// Sistema			: ECO
// Programa			: ECO024.PHP
// Descripcion		: Ingreso Exámen EcoDoppler Brazo.
...
<head><title>EcoDoppler Brazo</title>
<link href="ecocss/vvppcss.css" type="text/css" rel="stylesheet" />
 ...
 //         window.open('eco_autoriza.php?PAGINA=' + 'eco002.php' ,'Paciente','width=650, height=550, status=yes, resizable=no , menubar=yes, scrollbars=yes, location=no, top=150, left=220').focus();
	...
	/*-----------------------------------*/
        ...
        window.open('eco_autoriza.php?PAGINA=' + 'eco024_i.php?CODIGO=' + cod,'eco024_i','width=650, height=550, status= no, resizable= yes, menubar=yes, scrollbars=yes, location=no, top=150, left=220').focus();
...
La vena Humeral………… está permeable, compresibles sin defectos en su interior y midió……..mm de calibre dista .


Igual aspecto presenta la vena axilar …………, midió………mm de calibre con un flujo oscilante con los movimientos respiratorios.";
...
if (isset($_POST['txt_conclusion'])){
	...
	$conclusion_w = "PERMEABILIDAD ARTERIAL Y VENOSA PROFUNDA IZQUIERDA.";
	}
...
if ($_GET["CODIGO"] > 0)
	...
	$consulta="call ECO_PSEL_ECOBRAZO('".$_GET["CODIGO"]."',null,null,null,null,null)";
...
?> 
    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; left: 16px; position: absolute; top: 6px; height: 498px; width: 623px;" width="510">
      <tr>
        ...
        <td style="height: 24px" valign="bottom"> <span id="Label1" class="texto18">ECODOPPLER BRAZO</span></td>
            </tr>
            <tr>
                <td style="background-image: url(ivvpp0002.jpg); width: 34px; height: 24px">
                </td>
          ...
          <tr>
            ...
            <tr> 
              ...
              <td style="width: 314px; height: 4px"> 
			  <textarea name="txt_detalle" cols="70" rows="10" class="input-normal" ><?php echo $detalle_w; ?></textarea>
                </td>
            </tr>
            <tr> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 381px"> 
...
//		$sql1 = "call ECO_PUPD_PACIENTES('I','".$rut_w."','".$nombre_w."','".$apepat_w."','".$apemat_w."',null,null,null,null,null,null,null,null,null)";
		$sql1 = "call ECO_PUPD_ECOBRAZO('".$modo_w."','".$codigo_w."','".$rutpac_w."',STR_TO_DATE('".$fecha_w."','%d/%m/%Y'),";
