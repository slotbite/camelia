    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; left: 41px; position: absolute; top: 134px; height: 468px; width: 756px;" width="510">
      <tr> 
        ...
        <td style="height: 24px" valign="bottom"> <span id="Label1" class="texto18"> 
          ECOGRAFIA - RENAL</span></td>
      </tr>
      <tr> 
        <td style="width: 34px; height: 24px"> </td>
        <td height="100" width="480"> 
		<table width="512" height="387" border="0" cellpadding="0" cellspacing="0" class="texto13" id="Table2"
            ...
            <tr> 
              <td style="width: 115px; height: 2px"> RIÑON DERECHO</td>
            ...
            <tr> 
              <td style="width: 115px; height: 3px"> RIÑON IZQUIERDO</td>
              <td style="width: 314px; height: 3px"> 
            ...
            <tr> 
              <td style="width: 95px; height: 3px"> DETALLE EXAMEN</td>
              <td style="width: 314px; height: 3px"> 
                <?php echo $detalle_w; ?>
              </td>
            </tr>
