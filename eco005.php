...
?> 
  ...
  <div> 
    <table width="467" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td style="background-image: url(ieco/isase478.jpg);">&nbsp;</td>
        <td><span id="lblTit" class="texto18" style="display:inline-block;width:436px;">DATOS 
          USUARIO</span></td>
      </tr>
      <tr>
        <td style="background-image: url(ieco/isase478.jpg);">&nbsp;</td>
        <td style="background-image: url(ieco/isase473.jpg);height: 18px;">&nbsp;</td>
      </tr>
      <tr> 
        <td width="41" style="background-image: url(ieco/isase478.jpg);">&nbsp;</td>
        <td width="426"><table border="0" align="left" cellpadding="0" cellspacing="0" class="texto01" style="width: 328px">
            <tr> 
            ...
            <tr> 
              ...
              <td style="width: 318px; height: 19px"> <div style="text-align: left"> 
                  ...
                  &nbsp;</div>
                <span id="NombreMalo" style="color:Red;display:none;">* Nombre 
                inválido</span> </td>
            </tr>
            <tr> 
            ...
            <tr> 
              ...
              <td style="width: 318px; height: 19px"> <div style="text-align: left"> 
                  ...
                  &nbsp;</div><span id="emailMalo" class="texto01" style="color:Red;visibility:hidden;">Email 
          inválido</span></td>
            </tr>
            <tr> 
              <td colspan="2" style="background-image: url(ieco/isase476.jpg); height: 3px"> 
          ...
          <table width="423" border="0" cellpadding="0" cellspacing="0" class="texto01" id="Table2" style="width: 396px">
            <tr> 
            ...
            <tr> 
			 ...
			 if ($opc_w == 'I')
			 {
			   ...
			   { 
			   echo '<td style="width: 286px; height: 21px"> <input name="txtpass" type="password" maxlength="10" id="txtpass" class="input-normal"  value="'.$password_w.'" />' ;
              }
            ...
            <tr> 
			 ...
			 if ($opc_w == 'I')
			 {
              ...
              echo '<span id="RePassMalo" style="color:Red;display:none;">* Password no coincide</span> </td>' ;
            ...
            <tr> 
              ...
              <td style="width: 286px; height: 20px"> <input name="TB_inicio" type="text" value="<?php echo $finicio_w; ?>" maxlength="10" readonly="readonly" id="TB_inicio2" tabindex="2" class="input-normal" style="width:79px;" /> 
                &nbsp; &nbsp; </td>
            </tr>
            <tr> 
      ...
      <tr> 
        <td style="background-image: url(ieco/isase478.jpg);">&nbsp;</td>
        <td><table border="0" cellpadding="0" cellspacing="0" style="width: 316px; height: 24px;
            ...
            <tr> 
              <td style="width: 158px; height: 24px"> <div style="text-align: center"> 
                  ...
                  <input type="submit" name="btnCancelar" value="Cancelar" id="btnCancelar2" class="boton" onclick="javascript:window.close();"/>
                  </span></div></td>
              <td style="width: 158px; height: 24px; text-align: center"> <div style="text-align: center"> 
                  <span class="solicitud"> 
                  <input type="submit" name="btnAceptar" value="Aceptar" id="btnAceptar2" class="boton" />
                  </span></div></td>
            </tr>
          </table></td>
      </tr>
...
//		 exit();
 	...
 	if (strlen($password_w) == 0 and $opc_w == 'I') { //que ingrese password
...
//		 exit();
	...
	if ($password_w <> $repassword_w) { //que re-ingrese password
		   echo "<script type=\"text/javascript\">document.getElementById('RePassMalo').style.display=''</script>";
//		 exit();
		$error_w = TRUE;
...
//		mysql_select_db(DB_NAME, $link); 
		if (!$link) {
 		...
 		if (strlen($password_w) <> 0 ) 
			...
			{
			$sql1 = "call ECO_PUPD_USUARIO_SISTEMA('".$opc_w."','ECO','".$usuario_w."',null,STR_TO_DATE('".$finicio_w."','%d/%m/%Y'),null,null,null,null,'".$habilitado_w."','".$tipo_w."')";
			}
