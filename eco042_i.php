<?php
// Sistema			: ECO
// Programa			: eco042_i.PHP
// Descripcion		: Imprime Exámen EcoDoppler Pierna.
...
<head><title>Imprime EcoDoppler Pierna</title>
...
{ 
	...
	$consulta="call ECO_PSEL_ECOPIERNA('".$codigo_w."',null,null,null,null,null)";
...
?>
  ...
  <tr>
    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; position: absolute; width: 756px;" >
      <tr> 
        <td style="height: 24px" valign="bottom" colspan="2" align="center" width="500"> <span id="Label1" class="texto18"> 
          ECO DOPPLER EXTREMIDAD INFERIOR</span></td>
      </tr>
      <tr> 
        <td  colspan="2" align="left" height="100" width="600">
		 <table width="600" height="359" border="0" align="left" cellpadding="0" cellspacing="0" class="texto13" id="Table2"
           ...
           <tr> 
			...
			<tr> 
              <td style="width: 550px; height: 2px; text-align: justify;" colspan="2" >
            ...
            <tr> 
              <td  colspan="2"  align="center" style="width: 500px; height: 2px;text-decoration: underline;" class="txtngr">CONCLUSION</td>
              
            </tr>
			 <tr> 
              
              <td style="width: 550px; height: 3px" colspan="2"> 
