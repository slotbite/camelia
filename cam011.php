...
// Sistema			: CAMELIA
// Programa			: CAM011.PHP
// Descripcion		: Agrega colores al sistema.
...
<head><title>Ingreso de Colores</title>
...
if (!theForm) {
    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; left: 1px; position: absolute; top: 2px; height: 200px; width: 606px;" >
      <tr>
        ...
        <td align="top" width="484"> <table width="531" height="115" border="0" cellpadding="0" cellspacing="0" class="texto13"  id="Table2"
            ...
            <tr> 
			 ...
			 {
			   echo '<td style="width: 94px; height: 18px"> <input name="cmd_cod" type="text" maxlength="02" id="cmd_cod" class="input-normal" style="text-transform: uppercase;" value="'.$_SESSION["cod_s"].'" /> ';
			  }
			 else
			   { 
    ...
    if ( $error_w )	
	  {
	   exit();
		...
		if (!mysqli_query($link,$sql1)) 
		   ...
		   {
			echo "<script type=\"text/javascript\">
				alert('El Color: \' $cod_w \' ha sido registrado de manera satisfactoria.');
				</script>";
			mysqli_close($link);
			}	
