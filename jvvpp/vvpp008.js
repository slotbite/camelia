...
//	              var dsalida   = document.getElementById("dgrid_ctl0"+i+"_salida");
	              var dllegada  = document.getElementById("dgrid_ctl0"+i+"_HD_ffactini");
	              var dsalida   = document.getElementById("dgrid_ctl0"+i+"_HD_ffactter");
              } else {
...
//	              var dsalida   = document.getElementById("dgrid_ctl"+i+"_salida");
	              var dllegada  = document.getElementById("dgrid_ctl"+i+"_HD_ffactini");
	              var dsalida   = document.getElementById("dgrid_ctl"+i+"_HD_ffactter");
...
//	        var FecTerVal = new Date( dsalida.innerHTML.substr(6,4),  dsalida.innerHTML.substr(3,2), dsalida.innerHTML.substr(0,2));
	        ...
	        var FecIniVal = new Date( dllegada.value.substr(6,4),  dllegada.value.substr(3,2), dllegada.value.substr(0,2));
	        var FecTerVal = new Date( dsalida.value.substr(6,4),  dsalida.value.substr(3,2), dsalida.value.substr(0,2));
...
//alert('VAL: ' + dllegada.innerHTML.substr(0,2) + ' / ' + dllegada.innerHTML.substr(3,2) + ' / ' + dllegada.innerHTML.substr(6,4));
//alert('FECHAS: ' + fecha1.anio + ' / ' + fecha1.mes + ' / ' + fecha1.dia );
		    ...
		    var alojo    = document.getElementById("dgrid_ctl0"+i+"_aloj");
            var alojohf  = document.getElementById("dgrid_ctl0"+i+"_hf_aloja");
		    var desayuno = document.getElementById("dgrid_ctl0"+i+"_desay");
		    var desayunohf = document.getElementById("dgrid_ctl0"+i+"_hf_desay");
            var almuerzo = document.getElementById("dgrid_ctl0"+i+"_alm");
		    var almuerzohf = document.getElementById("dgrid_ctl0"+i+"_hf_alm");
            var cena     = document.getElementById("dgrid_ctl0"+i+"_cena");
		    var cenahf   = document.getElementById("dgrid_ctl0"+i+"_hf_cena");
		    var subtotal = document.getElementById("dgrid_ctl0"+i+"_valo_aloj");
		        // Valores Alojamiento
		    var vcosto   = document.getElementById("dgrid_ctl0"+i+"_costo_hab");
	        var vtotal   = document.getElementById("dgrid_ctl0"+i+"_tot_estimado");
		    } else {
			// Cantidad Alojamiento
		    var alojo    = document.getElementById("dgrid_ctl"+i+"_aloj");
            var alojohf  = document.getElementById("dgrid_ctl"+i+"_hf_aloja");
		    var desayuno = document.getElementById("dgrid_ctl"+i+"_desay");
		    var desayunohf = document.getElementById("dgrid_ctl"+i+"_hf_desay");
            var almuerzo = document.getElementById("dgrid_ctl"+i+"_alm");
		    var almuerzohf = document.getElementById("dgrid_ctl"+i+"_hf_alm");
            var cena     = document.getElementById("dgrid_ctl"+i+"_cena");
		    var cenahf   = document.getElementById("dgrid_ctl"+i+"_hf_cena");
		    var subtotal = document.getElementById("dgrid_ctl"+i+"_valo_aloj");
		       // Valores Alojamiento
		    var vcosto   = document.getElementById("dgrid_ctl"+i+"_costo_hab");
	        var vtotal   = document.getElementById("dgrid_ctl"+i+"_tot_estimado");
		    }
		    if ((dias * -1)=='0')
		    {
		          subtotal.innerHTML = parseInt(vcosto.innerHTML);
			      vtotal.innerHTML   = parseInt(vcosto.innerHTML);
			      alojo.innerHTML    = 1;
		          alojohf.value      = 1;
			...
			if (i<10) 
			{
				...
				Mostrar(i,'','');
		          ...
		          subtotal.innerHTML = (dias * -1) * parseInt(vcosto.innerHTML);
		    	  vtotal.innerHTML   = (dias * -1) * parseInt(vcosto.innerHTML);
		    	  desayuno.innerHTML = dias * -1;
		    	  desayunohf.value   = dias * -1;
		          almuerzo.innerHTML = dias * -1;
		    	  almuerzohf.value   = dias * -1;
		          cena.innerHTML     = dias * -1;
			      cenahf.value       = dias * -1;
			      alojo.innerHTML    = dias * -1;
			      alojohf.value      = dias * -1;
			if (i<10) 
			{
				Mostrar('0'+i,'','');
			} else {
