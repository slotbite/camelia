...
// Sistema			: ECO
// Programa			: ECO026.PHP
// Descripcion		: Ingreso Exámen EcoDoppler Carotideo.
...
<head><title>EcoDoppler Carotideo</title>
...
//          window.open('eco_autoriza.php?PAGINA=' + 'eco002.php' ,'Paciente','width=650, height=550, status=yes, resizable=no , menubar=yes, scrollbars=yes, location=no, top=150, left=220').focus();
	...
	/*-----------------------------------*/
        ...
        window.open('eco_autoriza.php?PAGINA=' + 'eco026_i.php?CODIGO=' + cod,'eco026_i','width=650, height=550, status= no, resizable= yes, menubar=yes, scrollbars=yes, location=no, top=150, left=220').focus();
...
if (isset($_POST['txt_detalle'])){
	...
	$detalle_w  = "Se exploraron vasos carotideos con transductor lineal 7.5 Mhz, con Doppler color.";
	}
if (isset($_POST['txt_artcarcomdi'])){
	$artcarcomdi_w  = trim($_POST['txt_artcarcomdi']);
	}
else{
	$artcarcomdi_w  = "Permeables, de morfología y aspecto normal.  Flujos conservados.  Midieron XXX y XXX mm de diámetro.";
	}
if (isset($_POST['txt_artcarintder'])){
	$artcarintder_w  = trim($_POST['txt_artcarintder']);
	}
else{
	$artcarintder_w  = "Permeable, lumen conservado. Al examen Doppler Color flujos conservados con una velocidad sistólica máxima de XXX cms./seg. Midió XXX mm de calibre proximal.";
	}
if (isset($_POST['txt_artcarextder'])){
	$artcarextder_w  = trim($_POST['txt_artcarextder']);
	}
else{
	$artcarextder_w  = "Permeable, lumen y conservado.";
	}
if (isset($_POST['txt_artcarintizq'])){
	$artcarintizq_w  = trim($_POST['txt_artcarintizq']);
	}
else{
	$artcarintizq_w  = "Permeable, lumen y flujo conservados.  Al examen Doppler Color, flujos conservados con una velocidad máxima de XXX cms/seg.  Midió XXX mm de calibre proximal.";
	}	
if (isset($_POST['txt_artcarextizq'])){
	$artcarextizq_w  = trim($_POST['txt_artcarextizq']);
	}
else{
	$artcarextizq_w  = "De morfología y aspecto normal. Flujo conservado.";
	}	
if (isset($_POST['txt_artverdi'])){
	$artverdi_w  = trim($_POST['txt_artverdi']);
	}
else{
	$artverdi_w  = "Permeables y amplias. Con flujo anterógrado.";
	}		
if (isset($_POST['txt_conclusion'])){
	$conclusion_w  = trim($_POST['txt_conclusion']);
	}
else{
	$conclusion_w = "Examen dentro de límites normales";
	}
...
if ($_GET["CODIGO"] > 0)
	...
	$consulta="call ECO_PSEL_ECOCAROTIDEO('".$_GET["CODIGO"]."',null,null,null,null,null)";
	...
	while ($row=mysqli_fetch_array($result))
		...
		$artcarcomdi_w  = $row["tartcarcomdi"];
		$artcarintder_w  = $row["tartcarintder"];
		$artcarextder_w  = $row["tartcarextder"];
		$artcarintizq_w  = $row["tartcarintizq"];
		$artcarextizq_w  = $row["tartcarextizq"];
		$artverdi_w   	= $row["tartverdi"];
    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; left: 16px; position: absolute; top: 6px; height: 498px; width: 623px;" width="510">
      <tr>
                ...
                <td style="height: 24px" valign="bottom">
                    <span id="Label1" class="texto18"> ECODOPPLER CAROTIDEO BILATERAL</span></td>
            </tr>
            <tr>
                <td style="background-image: url(ivvpp0002.jpg); width: 34px; height: 24px">
                </td>
          ...
          <tr>
            ...
            <tr> 
              <td style="width: 314px; height: 2px" colspan="2" class="txtngr">Detalle Exámen:</td>
             </tr>
			 <tr> 
              <td style=" height: 3px" colspan="2" align="center"><textarea name="txt_detalle" cols="80" rows="4" class="input-normal" ><?php echo $detalle_w; ?></textarea> 
              </td>
            </tr>
			<tr style="color: #000000"> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 381px"> 
            ...
            <tr> 
              <td style="width: 314px; height: 2px" colspan="2" class="txtngr">Arterias Carótidas Comunes Derecha e Izquierda :</td>
             </tr>
			 <tr> 
              <td style="height: 3px" colspan="2" align="center"><textarea name="txt_artcarcomdi" cols="80" rows="4" class="input-normal" ><?php echo $artcarcomdi_w; ?></textarea> 
              </td>
            </tr>
            <tr> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 381px"> 
			...
			<tr> 
              <td style="width: 314px; height: 2px" colspan="2" class="txtngr">Arteria Carótida Interna Derecha :</td>
             </tr>
			 <tr> 
              <td style="height: 3px" colspan="2" align="center"><textarea name="txt_artcarintder" cols="80" rows="4" class="input-normal" ><?php echo $artcarintder_w; ?></textarea> 
              </td>
            </tr>
             <tr> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 381px"> 
			...
			<tr> 
              <td style="width: 314px; height: 2px" colspan="2" class="txtngr">Arteria Carótida Externa Derecha :</td>
             </tr>
			 <tr> 
              <td style="height: 3px" colspan="2" align="center"><textarea name="txt_artcarextder" cols="80" rows="4" class="input-normal" ><?php echo $artcarextder_w; ?></textarea> 
              </td>
            </tr>
             <tr> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 381px"> 
			...
			<tr> 
              <td style="width: 314px; height: 2px" colspan="2" class="txtngr">Arteria Carótida Interna Izquierda :</td>
             </tr>
			 <tr> 
              <td style="height: 3px" colspan="2" align="center"><textarea name="txt_artcarintizq" cols="80" rows="4" class="input-normal" ><?php echo $artcarintizq_w; ?></textarea> 
              </td>
            </tr>
             <tr> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 381px"> 
			...
			<tr> 
              <td style="width: 314px; height: 2px" colspan="2" class="txtngr">Arteria Carótida Externa Izquierda :</td>
             </tr>
			 <tr> 
              <td style="height: 3px" colspan="2" align="center"><textarea name="txt_artcarextizq" cols="80" rows="4" class="input-normal" ><?php echo $artcarextizq_w; ?></textarea> 
              </td>
            </tr>
             <tr> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 381px"> 
			...
			<tr> 
              <td style="width: 314px; height: 2px" colspan="2" class="txtngr">Arteria Vertebral Derecha e Izquierda :</td>
             </tr>
			 <tr> 
              <td style="height: 3px" colspan="2" align="center"><textarea name="txt_artverdi" cols="80" rows="4" class="input-normal" ><?php echo $artverdi_w; ?></textarea> 
              </td>
            </tr>
             <tr> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 381px"> 
...
if ($_POST){
 if(isset($_POST["cmd_aceptar"])) 
 {
	...
	$artcarcomdi_w  = $_POST['txt_artcarcomdi'];
	$artcarintder_w  = $_POST['txt_artcarintder'];
	$artcarextder_w  = $_POST['txt_artcarextder'];
	$artcarintizq_w  = $_POST['txt_artcarintizq'];
	$artcarextizq_w  = $_POST['txt_artcarextizq'];
	$artverdi_w  = $_POST['txt_artverdi'];
...
//		$sql1 = "call ECO_PUPD_PACIENTES('I','".$rut_w."','".$nombre_w."','".$apepat_w."','".$apemat_w."',null,null,null,null,null,null,null,null,null)";
		$sql1 = "call ECO_PUPD_ECOCAROTIDEO('".$modo_w."','".$codigo_w."','".$rutpac_w."',STR_TO_DATE('".$fecha_w."','%d/%m/%Y'),";
        $sql1 = $sql1."'".$antecedentes_w."','".$detalle_w."','".$artcarcomdi_w."','".$artcarintder_w."','".$artcarextder_w."',";
        $sql1 = $sql1."'".$artcarintizq_w."','".$artcarextizq_w."','".$artverdi_w."','".$conclusion_w."','".$rutmed_w."',@cod_w)";
