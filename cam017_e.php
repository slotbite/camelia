<?php
// Sistema			: CAMELIA
// Programa			: CAM017_e.PHP
// Descripcion		: Elimina habilitados al sistema.
...
<head><title>Eliminación de Habilitados</title>
    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; left: 1px; position: absolute; top: 2px; height: 300px; width: 606px;" >
      <tr>
            <td style="height: 24px" valign="bottom">
                    <span id="Label1" class="texto18">ELIMINA HABILITADOS</span></td>
            </tr>
          <tr>
        <td align="top" width="584"> <table width="484" height="175" border="0" cellpadding="0" cellspacing="0" class="texto11" id="Table2"
			...
			<tr> 
              ...
              <td width="365" style="width: 314px; height: 18px"> <input name="cmd_ruthab" type="text" maxlength="13" id="cmd_ruthab" class="input-normal" style="text-transform: uppercase; width:76px;" onchange="vRut()" value="<?php echo $ruthab_w; ?>" readonly="readonly"/>
		...
		if (!mysqli_query($link,$sql1)) 
			{ $error = mysqli_error($link);
		     ...
		     if (mysqli_errno($link) == 1451)
			    {
				$merror = "El habilitado tiene movimientos asociados....." ;
				} 
