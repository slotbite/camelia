<?php
// Sistema			: ECO
// Programa			: eco030_i.PHP
// Descripcion		: Imprime Exámen EcoDoppler Venoso Bilateral.
...
<head><title>Imprime EcoDoppler Venoso Bilateral</title>
...
{ 
	...
	$consulta="call ECO_PSEL_ECODOPVENBILATERAL('".$codigo_w."',null,null,null,null,null)";
...
?>
  ...
  <tr>
    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; position: absolute; width: 756px;" >
      <tr> 
        <td style="height: 24px" valign="bottom"  align="center"  width="600" colspan="2"> <span id="Label1" class="texto18"> 
          ECODOPPLER COLOR VENOSO DE LAS EXTREMIDADES INFERIORES</span></td>
      </tr>
      <tr> 
        <td colspan="2" align="left" height="100" width="700"> 
		<table width="700" height="448" border="0" align="left" cellpadding="0" cellspacing="0" class="texto13" id="Table2"
           ...
           <tr> 
			...
			<tr> 
              <td style="width: 614px; height: 2px; text-align: justify;" colspan="2" >
            ...
            <tr> 
			 ...
			 <tr> 
              ...
              <td style="width: 614px; height: 3pxtext-align: justify;" colspan="2"> 
