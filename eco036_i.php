...
{ 
	...
	$consulta="call ECO_PSEL_ECODOPEXTINFERIOR('".$codigo_w."',null,null,null,null,null)";
...
?>
  ...
  <tr>
    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; position: absolute; width: 756px;" >
      <tr> 
        <td  colspan="2" style="height: 24px" valign="bottom" align="center" width="500"> <span id="Label1" class="texto18"> 
          ECO DOPPLER EXTREMIDADES INFERIORES</span></td>
      </tr>
      <tr> 
		...
		<table width="700" height="448" border="0" align="left" cellpadding="0" cellspacing="0" class="texto13" id="Table2"
           ...
           <tr> 
			...
			<tr> 
              <td style="width: 600px; height: 2px; text-align: justify;" colspan="2" >
