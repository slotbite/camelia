<?php
// Sistema			: CAMELIA
// Programa			: CAM_articulos.PHP
// Descripcion		: Seleción de Articulos.
...
//	$consulta="call cam_psel_locales('".$cod_w."')";
	$consulta="call cam_psel_articulos('".$cod_w."',null,null)";
...
//	    echo 'El valor es: <strong>'.$_POST['rbnRut'].'</strong><br />';
		if ($opc_w == "2") {
			...
			$_SESSION['codart_s'] = $_POST['rbnRut'] ;
			}
		$cod_w = $_POST['rbnRut'];
