...
function cam_valida_numdoc($pro, $tip, $num)
//---------------------------
{
//instanciamos el objeto para generar la respuesta con ajax
$respuesta = new xajaxResponse();
...
<div id="encabezado">
  ...
  <TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
            ...
            <td style="width: 95px; height: 2px">Nº Documento :</td>
			  ...
			  <input name="cmd_numdoc" type="text" maxlength="8" id="cmd_numdoc"  tabindex="3" value="<?php echo $_SESSION['numdoc_s']; ?>" onkeypress="return tabular(event,this)" onBlur="javascript:xajax_cam_valida_numdoc(document.Form1.cmd_codpro.value,document.Form1.cmd_tipdoc.value, document.Form1.cmd_numdoc.value)" />
