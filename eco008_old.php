          ...
          <tr>
            ...
            <tr> 
			 ...
			 <tr> 
              ...
              <td style="width: 314px; height: 3px"> <p>
                  <input name="cmd_medico" type="text" maxlength="60" id="cmd_medico" class="input-normal" style="width:176px;" value="<?php echo $_SESSION['nommed_s']; ?>" readOnly="readonly"/>
                  <input name="imgMedico" type="image" src="ieco/isase458.jpg" width="19" height="19" border="0" onclick="f_SelMedico()"/>
                  ...
                  <input name="cmd_especial" type="text" id="cmd_especial" class="input-normal" style="border:1px solid #FFFFFF;" value="<?php echo $_SESSION['especial_s']; ?>" readOnly="readonly"/>
				  </p></td>
            </tr>
...
*/
	...
	if (strlen($fecha_w) < 10) { //que ingrese nombre
	/*
