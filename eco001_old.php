...
<link href="ecocss/vvppcss.css" type="text/css" rel="stylesheet" />
    ...
    <script  type="text/javascript">
        ...
        function f_Modificar(cdes,ndes,mvig){
        /*-----------------------------------*/
...
/*				  
			...
			document.getElementById('hdHabilitado').value = "S";
			if (mvig == 'S')
				{ document.getElementById('slHabilitado').options(0).selected = true;  }
		    else
				{ document.getElementById('slHabilitado').options(1).selected = true;  }
...
//		$sql1 = "call ECO_PUPD_DESCRIPCIONES('I',null,'".$desc_w."','S','CIUDAD',null,null,null)";
		$sql1 = "call ECO_PUPD_DESCRIPCIONES('".$modo_w."',".$cod_w.",'".$desc_w."','".$habil_w."','".$concepto_w."',null,null,null)";
// echo $sql1;
...
?>
    ...
    <div>
        <table style="width: 712px; left: 5px; position: absolute; top: 3px;" cellspacing="0" id="TABLE1" onclick="return TABLE1_onclick()">
            <tr>
                <td style="width: 28px; background-image: url(isase/isase478.jpg);">
                </td>
                
 <!--    <td style="width: 636px"> <span id="Label2" class="texto18">LISTADO DE 
          DESCRIPCIONES </span></td>
 --> 
...
<!--
  <div id="PanelObs" style="background-color:White;border-color:#404040;border-width:1px;border-style:Solid;height:190px;width:380px;left:611px; position: absolute; top: 54px"> 
 <div id="PanelObs" style="background-color: #f2f4f4;border-color:#404040;border-width:1px;border-style:Solid;height:150px;width:380px;left:611px; position: absolute; top: 54px"> 
  ...
  <div id="PanelObs" style="background-color:White;border-color:#404040;border-width:3px;border-style:Solid;height:150px;width:368px;left:-711px; position: absolute; top: 64px"> 
    <table width="332" height="140" cellpadding="0" cellspacing="0" class="texto11" >
      ...
      <tr> 
        ...
        <td style="width: 200px; height: 6px"> <input type="button" name="btnNuevo2" value="Cerrar" id="btnNuevo2" class="boton" style="width:75px;"  onclick="javascript:hola(-1500);"/> 
          &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" name="btnAceptar" value="Aceptar" id="btnAceptar" class="boton" style="width:75px;" /> 
        </td>
        <!--  
      <td colspan="6" style="height: 6px; width: 20px;"><input type="submit" name="btnAceptar" value="Aceptar" onclick="f_UbicaPanel('btnCerrar',1,'btnCerrar','agregar');return false;" id="btnAceptar6" class="boton" style="width:75px;" /> 
        </td>
-->
      </tr>
    </table>
