...
// Sistema			: CAMELIA
// Programa			: CAM015.PHP
// Descripcion		: Agrega vendedores al sistema.
...
<head><title>Ingreso de Vendedores</title>
<link href="ecocss/vvppcss.css" type="text/css" rel="stylesheet" />
	...
	function vRut(){
   	/*----------------------------------*/
		var variable = Form1.cmd_rutven.value.substr(0,Form1.cmd_rutven.value.indexOf("-"));
		var digit = Form1.cmd_rutven.value.substr(Form1.cmd_rutven.value.indexOf("-")+1).toUpperCase();
		
		if ( validaRut(variable,digit) == false )
			  { alert("Rut Invalido") 
			}
		Form1.cmd_rutven.value = Form1.cmd_rutven.value.toUpperCase();
...
if (!theForm) {
    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; left: 1px; position: absolute; top: 2px; height: 300px; width: 606px;" >
      <tr>
          ...
          <tr>
        <td align="top" width="584"> <table width="566" height="175" border="0" cellpadding="0" cellspacing="0" class="texto13" id="Table2"
            ...
            <?php 
			if (strlen(trim($codven_w)) == 0)
			 {
			   echo '<td style="width: 94px; height: 18px"> <input name="cmd_codven" type="text" maxlength="02" id="cmd_codven" class="input-normal" style="text-transform: uppercase;width:56px;" value="'.$_SESSION["codven_s"].'" onchange="this.value = this.value.toUpperCase();"/> ';
			  }
			 else
			   { 
 			   echo '<td style="width: 94px; height: 18px"> <input name="cmd_codven" type="text" maxlength="02" id="cmd_codven" class="input-normal" style="text-transform: uppercase;width:56px;" value="'.$_SESSION["codven_s"].'" readOnly="readonly"/> ';
                }
			...
			<tr> 
              ...
              <td width="365" style="width: 314px; height: 18px"> <input name="cmd_rutven" type="text" maxlength="13" id="cmd_rutven" class="input-normal" style="text-transform: uppercase; width:76px;" onchange="vRut()" value="<?php echo $rutven_w; ?>" /> 
            ...
            <tr> 
              ...
              <td style="width: 314px; height: 3px"> <input name="cmd_pordes" type="text" maxlength="5" class="input-normal" id="cmd_pordes"  value="<?php echo $pordes_w; ?>" size="6" onKeypress="if ((event.keyCode < 46 || event.keyCode > 57) || event.keyCode == 47 ) event.returnValue = false;"/> 
              </td>
            </tr>
            <tr> 
          ...
          <table id="Table3" align="left" border="0" cellpadding="1" cellspacing="1"
                        style="height: 8px; background-color: whitesmoke;" width="482">
            <tr>
                            <td width="141" align="center" style="width: 126px">
                                <input type="submit" name="cmd_atras" value="Atras" id="cmd_atras" class="boton" style="width:70px;" /></td>
                            <td width="17" style="width: 15px">
                            </td>
                            <td width="143" align="center" style="width: 126px">
...
//exit();
		if (!mysqli_query($link,$sql1)) 
		   ...
		   {
			echo "<script type=\"text/javascript\">
				alert('El Vendedor: \' $codven_w \' ha sido registrado de manera satisfactoria.');
				</script>";
			mysqli_close($link);
			}	
