<?php
// Sistema			: ECO
// Programa			: eco028_i.PHP
// Descripcion		: Imprime Exámen EcoDoppler Arterial.
...
<head><title>Imprime EcoDoppler Arterial</title>
...
{ 
	...
	$consulta="call ECO_PSEL_ECODOPARTERIAL('".$codigo_w."',null,null,null,null,null)";
...
?>
  ...
  <tr>
    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; position: absolute; width: 756px;" >
      <tr> 
        <td style="height: 24px" valign="bottom" colspan="2" align="center" width="600"> <span id="Label1" class="texto18"> 
          ECODOPPLER COLOR ARTERIAL DE LAS EXTREMIDADES INFERIORES</span></td>
      </tr>
      <tr> 
        <td  colspan="2" align="left" height="100" width="600"> 
		<table width="600" height="448" border="0" align="left" cellpadding="0" cellspacing="0" class="texto13" id="Table2"
             style="height: 88px; text-align: left;">
            <tr> 
              <td colspan="2" style="width: 600px; height: 14px"> </td>
            </tr>
            <tr> </tr>
           ...
           <tr> 
			...
			<tr> 
			 ...
			 <tr> 
              <td  colspan="2" style="width: 314px; height: 2px">&nbsp;</td>
            </tr>
            <tr> 
              <td  colspan="2" style="width: 314px; height: 2px">&nbsp;</td>
            </tr>
