...
// Sistema			: ECO
// Programa			: ECO042.PHP
// Descripcion		: Ingreso Exámen EcoDoppler Pierna.
...
<head><title>EcoDoppler Pierna</title>
<link href="ecocss/vvppcss.css" type="text/css" rel="stylesheet" />
  ...
  //        window.open('eco_autoriza.php?PAGINA=' + 'eco002.php' ,'Paciente','width=650, height=550, status=yes, resizable=no , menubar=yes, scrollbars=yes, location=no, top=150, left=220').focus();
	...
	/*-----------------------------------*/
        ...
        window.open('eco_autoriza.php?PAGINA=' + 'eco042_i.php?CODIGO=' + cod,'eco042_i','width=650, height=550, status= no, resizable= yes, menubar=yes, scrollbars=yes, location=no, top=150, left=220').focus();
...
if (isset($_POST['txt_detalle'])){
	...
	$detalle_w  = "Se exploraron venas de la extremidad inferior con transductor lineal 7.5 Mhz. Con análisis doppler color.

La vena Femoral común  al igual que el Cayado Safena Interna son de aspecto normal, con lúmenes compresibles y superficies intimales sin defectos.  Al examen Doppler Color los flujos son bifásicos  competentes con maniobra de valsalva.

La vena Femoral Superficial es de aspecto y morfología normal con lumen y flujo conservados.   

La Vena poplítea presenta igual aspecto, midió…..   mm de calibre, con lumen compresible sin defectos en su interior.  Al Doppler Color no hay reflujo con maniobra de compresión proximal.

Cayado safena externa derecha competente.

Vena gemelar derecha permeable compresible.  Midió…….mm de calibre próximal.

Hacia distal las Venas Tibiales Posteriores Derechas están permeables y competente. Midieron……. mm  de calibre proximal y………..mm de calibre distal.

No se visualizan venas Perforantes.
";
	}
if (isset($_POST['txt_conclusion'])){
	...
	$conclusion_w = "PERMEABILIDAD VENOSA PROFUNDA…………… 
...
if ($_GET["CODIGO"] > 0)
	...
	$consulta="call ECO_PSEL_ECOPIERNA('".$_GET["CODIGO"]."',null,null,null,null,null)";
    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; left: 16px; position: absolute; top: 6px; height: 498px; width: 623px;" width="510">
      <tr>
        ...
        <td style="height: 24px" valign="bottom"> <span id="Label1" class="texto18"> 
          ECODOPPLER EXTREMIDAD INFERIOR</span></td>
            </tr>
            <tr>
                <td style="background-image: url(ivvpp0002.jpg); width: 34px; height: 24px">
                </td>
...
//		$sql1 = "call ECO_PUPD_PACIENTES('I','".$rut_w."','".$nombre_w."','".$apepat_w."','".$apemat_w."',null,null,null,null,null,null,null,null,null)";
		$sql1 = "call ECO_PUPD_ECOPIERNA('".$modo_w."','".$codigo_w."','".$rutpac_w."',STR_TO_DATE('".$fecha_w."','%d/%m/%Y'),";
