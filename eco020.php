...
// Sistema			: ECO
// Programa			: ECO020.PHP
// Descripcion		: Ingreso Exámen EcoPelviana Femenina.
...
<head><title>EcoPelviana Femenina</title>
...
//          window.open('eco_autoriza.php?PAGINA=' + 'eco002.php' ,'Paciente','width=650, height=550, status=yes, resizable=no , menubar=yes, scrollbars=yes, location=no, top=150, left=220').focus();
	...
	/*-----------------------------------*/
        ...
        window.open('eco_autoriza.php?PAGINA=' + 'eco020_i.php?CODIGO=' + cod,'eco020_i','width=650, height=550, status= no, resizable= yes, menubar=yes, scrollbars=yes, location=no, top=150, left=220').focus();
...
if (isset($_POST['txt_vejiga'])){
	$vejiga_w  = trim($_POST['txt_vejiga']);
	}
else{
	$vejiga_w  = "Bien llena, de paredes normales, sin imágenes ecogénicas en su interior.";
	}
if (isset($_POST['txt_utero'])){
	$utero_w  = trim($_POST['txt_utero']);
	}
else{
	$utero_w  = "En anteversoflexión.  De estructura y dimensiones normales.";
	}
if (isset($_POST['txt_ovarioizq'])){
	$ovarioizq_w  = trim($_POST['txt_ovarioizq']);
	}
else{
	$ovarioizq_w  = "De tamaño y configuración ecográfica normal.";
	}
if (isset($_POST['txt_ovarioder'])){
	$ovarioder_w  = trim($_POST['txt_ovarioder']);
	}
else{
	$ovarioder_w  = "De tamaño y configuración ecográfica normal";
	}
if (isset($_POST['txt_douglas'])){
	$douglas_w  = trim($_POST['txt_douglas']);
	}
else{
	$douglas_w  = "Sin fluido.";
	}
...
if ($_GET["CODIGO"] > 0)
	...
	$consulta="call ECO_PSEL_ECOPELVIFEM('".$_GET["CODIGO"]."',null,null,null,null,null)";
    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; left: 16px; position: absolute; top: 6px; height: 498px; width: 623px;" width="510">
      <tr>
                ...
                <td style="height: 24px" valign="bottom">
                    <span id="Label1" class="texto18"> ECOPELVIANA FEMENINA</span></td>
            </tr>
            <tr>
                <td style="background-image: url(ivvpp0002.jpg); width: 34px; height: 24px">
                </td>
          ...
          <tr>
            ...
            <tr> 
              <td style="width: 105px; height: 2px">VEJIGA</td>
              <td style="width: 314px; height: 3px"> 
			  <textarea name="txt_vejiga" cols="60" rows="3" class="input-normal" ><?php echo $vejiga_w; ?></textarea>
                </td>
            </tr>
            <tr> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 381px"> 
			  ...
			  <tr> 
              <td style="width: 105px; height: 2px">UTERO</td>
              <td style="width: 314px; height: 3px"> <textarea name="txt_utero" cols="60" rows="3" class="input-normal" ><?php echo $utero_w; ?></textarea></td>
            </tr>
            <tr> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 381px"> 
              </td>
			  ...
			  <tr> 
              <td style="width: 105px; height: 2px">OVARIO IZQUIERDO</td>
              <td style="width: 314px; height: 3px"> 
			  <textarea name="txt_ovarioizq" cols="60" rows="3" class="input-normal" ><?php echo $ovarioizq_w; ?></textarea>
                </td>
            </tr>
            <tr> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 381px"> 
			  ...
			  <tr> 
              <td style="width: 105px; height: 2px">OVARIO DERECHO</td>
              <td style="width: 314px; height: 3px"> 
			  <textarea name="txt_ovarioder" cols="60" rows="3" class="input-normal" ><?php echo $ovarioder_w; ?></textarea>
                </td>
            </tr>
            <tr> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 381px"> 
			  ...
			  <tr> 
              <td style="width: 105px; height: 2px">DOUGLAS</td>
              <td style="width: 314px; height: 3px"> 
			  <textarea name="txt_douglas" cols="60" rows="3" class="input-normal" ><?php echo $douglas_w; ?></textarea>
                </td>
            </tr>
            <tr> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 381px"> 
...
//		$sql1 = "call ECO_PUPD_PACIENTES('I','".$rut_w."','".$nombre_w."','".$apepat_w."','".$apemat_w."',null,null,null,null,null,null,null,null,null)";
		$sql1 = "call ECO_PUPD_ECOPELVIFEM('".$modo_w."','".$codigo_w."','".$rutpac_w."',STR_TO_DATE('".$fecha_w."','%d/%m/%Y'),";
        $sql1 = $sql1."'".$vejiga_w."','".$utero_w."','".$ovarioizq_w."','".$ovarioder_w."','".$douglas_w."','".$conclusion_w."','".$rutmed_w."',@cod_w)";
