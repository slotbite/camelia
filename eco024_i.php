<?php
// Sistema			: ECO
// Programa			: eco024_i.PHP
// Descripcion		: Imprime Exámen EcoDoppler Brazo.
...
<head><title>Imprime EcoDoppler Brazo</title>
...
{ 
	...
	$consulta="call ECO_PSEL_ECOBRAZO('".$codigo_w."',null,null,null,null,null)";
...
?>
  ...
  <tr>
    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; position: absolute; " width="700">
      <tr> 
        <td colspan="2" style="height: 24px" width="500" align="center" valign="bottom"> <span id="Label1" class="texto18"> 
          ECO DOPPPLER - VENOSO EXTREMIDAD SUPERIOR</span></td>
      </tr>
      <tr> 
        <td  colspan="2" align="left" height="100" width="480"> 
		<table width="512" height="387" border="0" align="left" cellpadding="0" cellspacing="0" class="texto13" id="Table2"
            ...
            <tr> 
              <td style="width: 115px; height: 3px" colspan="2"> DETALLE EXAMEN</td>
			...
			<tr> 
			 ...
			 <tr> 
              <td style="width: 514px; height: 3px" colspan="2"> 
