	...
	-->
	 <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; position: absolute; width: 723px;" >
	  ...
	  <!--
		...
		-->
        <td  colspan="2"style="height: 24px" width="500" align="center"> <span id="Label1" class="texto18"> 
	  ...
	  <!--
        <td style="width: 34px; height: 24px"> </td>
		-->
        <td  colspan="2" align="left" height="100" width="520">
		 <table width="520" height="448" border="0" align="left" cellpadding="0" cellspacing="0" class="texto13" id="Table2"
           ...
           <tr> 
            ...
            <tr> 
              ...
              <td style="width: 500px; height: 3px"></td>
            </tr>
			<tr> 
			 ...
			 <tr> 
              ...
              <td style="width: 500px; height: 2px">&nbsp;</td>
            </tr>
            <tr> 
              <td height="37" style="width: 105px; height: 2px">&nbsp;</td>
              <td style="width: 500px; height: 2px">&nbsp;</td>
			...
			<tr> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 500px"> 
              </td>
            </tr>
            <tr> 
              <td  colspan="2" style="width: 105px; height: 2px;text-decoration: underline;" class="txtngr">CONCLUSION</td>
            ...
            <tr> 
              <td style="width: 205px; height: 2px">&nbsp; </td>
              <td style="width: 314px; height: 3px"> 
                <?php echo $rutmed_w; ?>
              </td>
            </tr>
