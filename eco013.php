...
?>
	...
	<div>
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; left: 16px; position: absolute; top: 9px; height: 387px; width: 619px;" width="510">
      <tr>
                <td width="35" style="background-image: url(ivvpp0002.jpg); width: 34px; height: 24px">
                </td>
        ...
        <td style="height: 24px" valign="bottom"> <span id="Label1" class="texto18"> 
          ...
          <tr>
                ...
                <td align="center" height="100" width="588">
...
<!--             <tr> 
              <td colspan="2" style="width: 381px; height: 14px"><div align="center"><img src="ieco/logo2.jpg" width="274" height="323" /> 
                </div></td>
            </tr>
 -->            <tr> 
            ...
            <tr style="color: #000000"> 
              ...
              <td width="365" style="width: 314px; height: 3px"> <input name="usuario" type="text" class="input-normal" style="border:1px solid #FFFFFF;" value="<?php echo $usuario_w; ?>" readOnly="readonly" />
