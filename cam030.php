...
// Sistema			: CAMELIA
// Programa			: CAM030.PHP
// Descripcion		: Consulta de Ventas x Fecha.
...
<HTML>
	<head>
		<title>Consulta Ventas x Fecha</title>
...
//		    alert(cod1+','+cod2);
			...
			window.open('cam030_i.php?CODIGO=' + cod,'cam030_i','width=750, height=550, status= no, resizable= yes, menubar=yes, scrollbars=yes, location=no, top=150, left=220').focus();
		...
		<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="530" border="0">
			<TR>
				<td vAlign="bottom" width="500">&nbsp;
					<span id="Label1" class="texto18">CONSULTA VENTAS POR FECHA</span></td>
			</TR>
<!-- 			<TR>
 ...
 -->			<TR>
				<td align="left" width="500" height="6">
					<TABLE class="texto13" id="Table2" cellPadding="0" width="665" border="0">
        <TR> 
						<td width="113" style="WIDTH: 70px; HEIGHT: 12px"></td>
						<td width="254" style="WIDTH: 224px; HEIGHT: 12px"></td>
						<td width="115" style="WIDTH: 70px; HEIGHT: 12px"></td>
						<td width="173" style="HEIGHT: 12px"></td>
					  </TR>
					  <TR> 
						<td style="WIDTH: 70px; HEIGHT: 3px">&nbsp;&nbsp;&nbsp;&nbsp;Cód.Local</td>
						<td style="WIDTH: 224px; HEIGHT: 3px"><input name="cmd_codloc" type="text" id="cmd_codloc" class="input-normal" style="width:66px;" value="<?php if (isset($_SESSION['codloc_s'])){ echo $_SESSION['codloc_s']; } ?>"/></td>
