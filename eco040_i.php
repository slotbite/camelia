<?php
// Sistema			: ECO
// Programa			: eco040_i.PHP
// Descripcion		: Imprime Exámen EcoDoppler Arterial Extremidades Superiores.
...
<head><title>Imprime EcoDoppler Arterial Extremidades Superiores</title>
...
{ 
	...
	$consulta="call ECO_PSEL_ECODOPARTBRAZO('".$codigo_w."',null,null,null,null,null)";
...
?>
  ...
  <tr>
    ...
    <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="z-index: 101; position: width: 756px;" >
      <tr> 
        <td style="height: 24px" valign="bottom" colspan="2" align="center" width="600"> <span id="Label1" class="texto18"> 
          ECO DOPPLER ARTERIAL EXTREMIDADES SUPERIORES</span></td>
      </tr>
      <tr> 
