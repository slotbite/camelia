...
// Sistema			: ECO
// Programa			: ECO034.PHP
// Descripcion		: Ingreso Exámen EcoPelviana Masculina.
...
<head><title>EcoPelviana Masculina</title>
<link href="ecocss/vvppcss.css" type="text/css" rel="stylesheet" />
 ...
 //         window.open('eco_autoriza.php?PAGINA=' + 'eco002.php' ,'Paciente','width=650, height=550, status=yes, resizable=no , menubar=yes, scrollbars=yes, location=no, top=150, left=220').focus();
	...
	/*-----------------------------------*/
        ...
        window.open('eco_autoriza.php?PAGINA=' + 'eco034_i.php?CODIGO=' + cod,'eco034_i','width=650, height=550, status= no, resizable= yes, menubar=yes, scrollbars=yes, location=no, top=150, left=220').focus();
...
if (isset($_POST['txt_vejiga'])){
	...
	$vejiga_w  = "Bien llena.  De pared fina y regular.  Sin imágenes ecogénicas en su interior.";
	}
if (isset($_POST['txt_prostata'])){
	$prostata_w  = trim($_POST['txt_prostata']);
	}
else{
	$prostata_w  = "De estructura homogénea.  Mide XXX mm de diámetro anteroposterior x XXX mm de diámetro transversal  x  XXX mm de diámetro cefocaudal.
	Lo anterior permite estimar su peso en aprox XXX gr (normal).";
	}
if (isset($_POST['txt_rpm'])){
	$rpm_w  = trim($_POST['txt_rpm']);
	}
else{
	$rpm_w  = "";
	}
...
if (isset($_POST['txt_diagnostica'])){
	...
	$diagnostica_w = "MODERADO AUMENTO DEL VOLUMEN PROSTÁTICO.
";
	}
...
if ($_GET["CODIGO"] > 0)
	...
	$consulta="call ECO_PSEL_ECOPELVIMASC('".$_GET["CODIGO"]."',null,null,null,null,null)";
      ...
      <tr>
        ...
        <td style="height: 24px" valign="bottom"> <span id="Label1" class="texto18"> 
          ...
          <tr>
            ...
            <tr> 
              <td style="width: 105px; height: 2px">PROSTATA</td>
              <td style="width: 314px; height: 3px"> <textarea name="txt_prostata" cols="60" rows="3" class="input-normal" ><?php echo $prostata_w; ?></textarea></td>
            </tr>
            <tr> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 381px"> 
              </td>
			  ...
			  <tr> 
              <td style="width: 105px; height: 2px">RPM</td>
              <td style="width: 314px; height: 3px"> 
			  <textarea name="txt_rpm" cols="60" rows="3" class="input-normal" ><?php echo $rpm_w; ?></textarea>
                </td>
            </tr>
            <tr> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 381px"> 
...
//		$sql1 = "call ECO_PUPD_PACIENTES('I','".$rut_w."','".$nombre_w."','".$apepat_w."','".$apemat_w."',null,null,null,null,null,null,null,null,null)";
		$sql1 = "call ECO_PUPD_ECOPELVIMASC('".$modo_w."','".$codigo_w."','".$rutpac_w."',STR_TO_DATE('".$fecha_w."','%d/%m/%Y'),";
        $sql1 = $sql1."'".$vejiga_w."','".$prostata_w."','".$rpm_w."','".$diagnostica_w."','".$rutmed_w."',@cod_w)";
