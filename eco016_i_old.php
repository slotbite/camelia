...
-->
      <tr>
        ...
        <td style="height: 20px" valign="bottom" align="center" width="400"> <span id="Label1" class="texto18"> 
          ECOCARDIOGRAFIA - DOPPLER</span></td>
            </tr>
          ...
          <tr>
            ...
            <tr style="color: #000000"> 
              <td width="98" height="21" style="width: 85px; height: 2px"> &nbsp;Código</td>
              <td  colspan="3" style="width: 314px; height: 3px"> <?php echo $codigo_w; ?></td>

            </tr>
            
            <tr style="color: #000000"> 
              <td height="25" style="width: 95px; height: 2px">&nbsp;Nombre Paciente</td>
              <td  colspan="3" style="width: 314px; height: 3px"> <?php echo $nompac_w ?> </td> 

            </tr>
            <tr> 
              <td height="22" style="width: 85px; height: 18px"> &nbsp;Rut</td>
              <td width="158" style="width: 95px; height: 18px" > <?php echo $rutpac_w; ?></td>
               <td width="130" style="width: 95px; height: 18px" >&nbsp;Fecha Examen</td>
                <td width="160" style="width: 114px; height: 18px">&nbsp;<?php echo $fecha_w; ?></td>


            </tr>
            <tr> 
              <td height="16" style="width: 85px; height: 2px">&nbsp;</td>
              <td colspan="4" style="width: 314px; height: 3px">&nbsp;</td>
            </tr>
			</table>
			
          <table width="538" border="1" cellspacing="0" cellpadding="0" class="texto13">
            <tr> 
              <td colspan="3" style="width: 150px; height: 2px" class="txtngr">VENTRICULO 
                IZQUIERDO </td>
              <td colspan="3" style="width: 125px; height: 2px" class="txtngr">FUNCION 
                SISTOLICA </td>
            </tr>
            <tr> 
            ...
            <tr> 
              ...
              <td height="16" colspan="3" style="width: 135px; height: 2px" class="txtngr">FUNCION 
                DIASTOLICA </td>
               </tr>
            <tr> 
            ...
            <tr> 
              <td width="145" align="left">AURICULA IZQDA :</td>
          ...
          <table id="Table3" align="center" border="0" cellpadding="0" cellspacing="0" class="texto13"
			...
			<tr> 
              <td colspan="2" align="justify" style="width: 414px; height: 3px"><?php echo $conclusion_w;?></td>
               </tr>
			  <tr> 
              <td background="ivvpp0003.jpg" colspan="2" height="2" style="width: 381px"> 
              </td>
