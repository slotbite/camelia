<?php
// Sistema			: CAMELIA
// Programa			: CAM028_i.PHP
// Descripcion		: Imprime Colores por nombre.
...
$cod2_w = substr($_GET["CODIGO"], $pos1 + 1, 15) ;
//echo 'cod:' . $codigo_w;
?>
...
<?php	
	...
	//Ejecutamos la sentencia SQL
		$consulta="call cam_psel_colores_3('".$cod1_w."','".$cod2_w."')";
    ...
    echo '<tr>'; 
	echo '	<th>Nombre Color</th><th>Código Color</th>';
	echo '</tr>';
			  echo '<tr >'; 
