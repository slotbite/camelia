<?php
// Sistema			: CAMELIA
// Programa			: CAM_colores.PHP
// Descripcion		: Seleción de Colores.
...
?>
		<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="530" border="0">
			<TR>
	    <td vAlign="bottom" width="500">&nbsp; <span id="Label1" class="texto18">COLORES</span></td>
			</TR>
...
//	$consulta="call cam_psel_locales('".$cod_w."')";
	$consulta="call cam_psel_colores(null,null)";
...
//	    echo 'El valor es: <strong>'.$_POST['rbnRut'].'</strong><br />';
		if ($opc_w == "2") {
			...
			$_SESSION['codcol_s'] = $_POST['rbnRut'] ;
			}
